...
document.querySelector('.navbar__link--about').addEventListener('click', () => {
  scrollIt(
...
document.querySelector('.navbar__link--services').addEventListener('click', () => {
  scrollIt(
...
// Scroll to about section
document.querySelector('.navbar__link--portfolio').addEventListener('click', () => {
  scrollIt(
...
// Scroll to about section
document.querySelector('.navbar__link--team').addEventListener('click', () => {
  scrollIt(
...
document.querySelector('.navbar__link--contact').addEventListener('click', () => {
  scrollIt(
